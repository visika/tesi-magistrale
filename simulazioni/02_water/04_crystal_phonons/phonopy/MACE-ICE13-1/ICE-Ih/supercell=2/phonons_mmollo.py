...
def optimize(a: Atoms, fmax: float, output: str = "optimized.xyz") -> None:
    opt = BFGS(a, trajectory="optimization.traj", logfile="optimization.log")
    opt.run(fmax=fmax)
...
atoms = read(filename="/ibiscostorage/mmollo/tesi-magistrale/strutture/ICE13/Ih/POSCAR")
