...
app = marimo.App(width="medium", app_title="PHON interface with ASE")
...
@app.cell
def __(MACECalculator, copyfile, np, read, subprocess):
    ...
    return atoms, calc, disp, dtype, supercell
...
@app.cell
def __(Bar, datetime, disp, dynmat):
...
def __(atoms):
    ...
    return bandpath_gupta, labels_gupta, path_gupta


@app.cell
def __(datetime, np, os, path_gupta, subprocess):
